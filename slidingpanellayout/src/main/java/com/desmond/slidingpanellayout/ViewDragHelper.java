...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
         ...
         *
         * @param changeView View whose position changed
         ...
         * currently dragging the captured view is supplied. If the activePointerId is
         ...
         * @param xvel X velocity of the pointer as it leaves the screen in pixels per second
         * @param yvel Y velocity of the pointer as it leaves the screen in pixels per second
         */
     ...
     * This will allow ViewDragHelper to use internal compatibility implementations for different
     * platform versions.
     *
     * @param context Context to initialize config-dependent params from
     * @param forParent Parent view to monitor
     */
    private ViewDragHelper(Context context, @NonNull ViewGroup forParent, @NonNull Callback cb) {
